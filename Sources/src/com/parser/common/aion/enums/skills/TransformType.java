...
public enum TransformType {
	...
	private TransformType(String clientString) {
	 ...
	 */
	public static TransformType fromClient(String string) {
		for (TransformType v : values()) {
		...
		System.out.println("[SKILLS] No TransformType matching :" + string);
		return null;
	}
	
	public static TransformType fromValue(String name) {
		for (TransformType v : values()) {
